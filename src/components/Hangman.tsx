...
const Hangman = (props: IHangmanProps) => {
    ...
    const anim = (props.gameStatus == GameStatus.Defeat ? "swing" : "");
            ...
            <div className={`m-auto`}>
                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                    ...
                    <g className={`${anim}`}>
                        ...
                        {(props.try > 5 && props.gameStatus !== GameStatus.Victory) && <rect x="164.1" y="33.5" className={`rope`} width="3.1" height="47.4" />}
                        {(props.try > 5 || props.gameStatus === GameStatus.Victory) && <ellipse className={`head`} cx="164.4" cy="91.9" rx="27.1" ry="23.5" />}
                        {(props.try > 6) && (
                            <>
                                <g>
                                    <line className={`deadface l-eye `} x1="152.8" y1="81.8" x2="156.7" y2="87.6" />
                                    <line className={`deadface l-eye `} x1="152.1" y1="87" x2="157.5" y2="82.5" />
                                </g>
                                <g>
                                    <line className={`deadface r-eye`} x1="170.6" y1="83" x2="176.6" y2="92" />
                                    <line className={`deadface r-eye`} x1="169.4" y1="90.9" x2="177.7" y2="84.1" />
                                </g>
                                <line className={`deadface mouth`} x1="149.4" y1="98.9" x2="171.8" y2="102" />
                    ...
                    {props.gameStatus === GameStatus.Victory && (
                        <>
                            <path className={`st6 tongue ${anim}`} d="M171.8,100.1c-0.7,3.2-9.3,7.6-13.7,7c-5.2-0.7-7.6-10.1-1.5-9.4C161.8,98.3,172.2,97.8,171.8,100.1z" />
